...
export default function Eligibility() {
  return (
    <div className="flex bg-[#222] w-full py-[3.5rem] px-[6.5rem] flex-col gap-6">
      <h3 className="font-poppins font-bold text-[1.75rem] text-active-white">
        Grant Eligibility
      </h3>
      <Paragraph className="!text-[1.25rem] !leading-[190%] w-[57.3125rem]">
